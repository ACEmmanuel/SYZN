            ...
            {/* <img src='flying-dollar.png' className='absolute top-0 left-0 object-contain' /> */}
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-4  gap-y-20'>
                ...
                <div className='text-center lg:text-left max-w-xl mx-auto'>
                  <h4 >TESTIMONIAL</h4>
                  <h2 className='lg:pr-8'>Trusted by over 300 companies around the world</h2>
                  ...
                  
                {
                    data.map((e) => {
                        ...
                        return (
                           <div className='flex flex-col gap-2 rounded-xl px-2 mx-auto text-[1rem] font-DM' key={id}>
